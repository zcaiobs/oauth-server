...
import com.example.oauthserver.domain.UserEntity;
import com.example.oauthserver.domain.UserRepository;
...
public class AuthSecurityConfig {
    ...
    public JWKSet jwkSet(AuthProperties authProperties) throws Exception {
        ...
        RSAKey rsaKey = RSAKey
                .load(keyStore, jksProperties.getAlias(), jksProperties.getKeypass().toCharArray());
